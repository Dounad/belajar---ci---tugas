...
<div class="d-flex align-items-center justify-content-between">
  <a href="index.html" class="logo d-flex align-items-center">
    <img src="<?= base_url()?>NiceAdmin/assets/img/ndutmotors.png" alt="">
    <span class="d-none d-lg-block text-black">Ndut Motor </span>
  </a>
...
<?php if (session()->has('today_discount')): // Cek apakah ada nominal diskon di session ?>
    <div style="
        background-color:rgb(2, 239, 93); /* Warna hijau */
        color: white;
        padding: 8px 15px;
        border-radius: 5px;
        font-weight: bold;
